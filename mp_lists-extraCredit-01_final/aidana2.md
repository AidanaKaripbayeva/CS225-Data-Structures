...
==41714== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==41714== Command: ./test -r xml "List::insertFront\ size"
==41714== 
==41714== Conditional jump or move depends on uninitialised value(s)
==41714==    at 0x42831C: List<int>::insertFront(int const&) (List.hpp:75)
==41714==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==41714==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==41714==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==41714==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==41714==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==41714==    by 0x44D11E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==41714==    by 0x4564B6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==41714==    by 0x455152: Catch::Session::runInternal() (catch.hpp:10149)
==41714==    by 0x454E1A: Catch::Session::run() (catch.hpp:10106)
==41714==    by 0x454D99: Catch::Session::run(int, char**) (catch.hpp:10074)
==41714==    by 0x481E11: main (catch.hpp:13613)
==41714== 
==41714== Conditional jump or move depends on uninitialised value(s)
==41714==    at 0x428356: List<int>::insertFront(int const&) (List.hpp:78)
==41714==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==41714==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==41714==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==41714==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==41714== 
==41714== Conditional jump or move depends on uninitialised value(s)
==41714==    at 0x452760: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==41714==    by 0x43063B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==41714==    by 0x422154: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==41714==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==41714==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==41714==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==41714==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==41714== 
==41714== HEAP SUMMARY:
==41714==     in use at exit: 240 bytes in 10 blocks
==41714==   total heap usage: 2,132 allocs, 2,122 frees, 252,400 bytes allocated
==41714== 
==41714== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==41714==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==41714==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==41714==    by 0x4282D3: List<int>::insertFront(int const&) (List.hpp:71)
==41714==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==41714==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==41714==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==41714==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==41714== 
==41714== LEAK SUMMARY:
==41714==    definitely lost: 240 bytes in 10 blocks
==41714==    indirectly lost: 0 bytes in 0 blocks
==41714==      possibly lost: 0 bytes in 0 blocks
==41714==    still reachable: 0 bytes in 0 blocks
...
==41714== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
```
==41727== Memcheck, a memory error detector
==41727== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==41727== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==41727== Command: ./test -r xml "List::_destroy\ empty\ list"
==41727== 
==41727== 
==41727== HEAP SUMMARY:
==41727==     in use at exit: 0 bytes in 0 blocks
==41727==   total heap usage: 2,140 allocs, 2,140 frees, 253,232 bytes allocated
==41727== 
==41727== All heap blocks were freed -- no leaks are possible
==41727== 
==41727== For counts of detected and suppressed errors, rerun with: -v
==41727== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **aidana2** using **f8a1f9ace41ba3ad91a3c0543b5384255b359582** (from **February 24th 2020, 11:59:59 pm**)
