...
```
==37541== Memcheck, a memory error detector
==37541== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==37541== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==37541== Command: ./test -r xml "List::insertFront\ size"
==37541== 
==37541== Conditional jump or move depends on uninitialised value(s)
==37541==    at 0x42831C: List<int>::insertFront(int const&) (List.hpp:75)
==37541==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==37541==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==37541==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==37541==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==37541==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==37541==    by 0x44D11E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==37541==    by 0x4564B6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==37541==    by 0x455152: Catch::Session::runInternal() (catch.hpp:10149)
==37541==    by 0x454E1A: Catch::Session::run() (catch.hpp:10106)
==37541==    by 0x454D99: Catch::Session::run(int, char**) (catch.hpp:10074)
==37541==    by 0x481E11: main (catch.hpp:13613)
==37541== 
==37541== Conditional jump or move depends on uninitialised value(s)
==37541==    at 0x428356: List<int>::insertFront(int const&) (List.hpp:78)
==37541==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==37541==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==37541==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==37541==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==37541== 
==37541== Conditional jump or move depends on uninitialised value(s)
==37541==    at 0x452760: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==37541==    by 0x43063B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==37541==    by 0x422154: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==37541==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==37541==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==37541==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==37541==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==37541== 
==37541== HEAP SUMMARY:
==37541==     in use at exit: 240 bytes in 10 blocks
==37541==   total heap usage: 2,132 allocs, 2,122 frees, 252,400 bytes allocated
==37541== 
==37541== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==37541==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==37541==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==37541==    by 0x4282D3: List<int>::insertFront(int const&) (List.hpp:71)
==37541==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==37541==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==37541==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==37541==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==37541== 
==37541== LEAK SUMMARY:
==37541==    definitely lost: 240 bytes in 10 blocks
==37541==    indirectly lost: 0 bytes in 0 blocks
==37541==      possibly lost: 0 bytes in 0 blocks
==37541==    still reachable: 0 bytes in 0 blocks
==37541==         suppressed: 0 bytes in 0 blocks
==37541== 
==37541== For counts of detected and suppressed errors, rerun with: -v
==37541== Use --track-origins=yes to see where uninitialised values come from
==37541== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==37608== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==37608== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==37608== Command: ./test -r xml "List::_destroy\ empty\ list"
==37608== 
==37608== 
==37608== HEAP SUMMARY:
==37608==     in use at exit: 0 bytes in 0 blocks
==37608==   total heap usage: 2,140 allocs, 2,140 frees, 253,232 bytes allocated
==37608== 
==37608== All heap blocks were freed -- no leaks are possible
==37608== 
==37608== For counts of detected and suppressed errors, rerun with: -v
==37608== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **aidana2** using **f8a1f9ace41ba3ad91a3c0543b5384255b359582** (from **February 25th 2020, 11:59:59 pm**)
