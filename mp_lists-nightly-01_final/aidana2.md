...
```
==11252== Memcheck, a memory error detector
==11252== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==11252== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==11252== Command: ./test -r xml "List::insertFront\ size"
==11252== 
==11252== Conditional jump or move depends on uninitialised value(s)
==11252==    at 0x4364DC: List<int>::insertFront(int const&) (List.hpp:55)
==11252==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==11252==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==11252==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==11252==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==11252==    by 0x45EED6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==11252==    by 0x45D4AE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==11252==    by 0x466846: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==11252==    by 0x4654E2: Catch::Session::runInternal() (catch.hpp:10149)
==11252==    by 0x4651AA: Catch::Session::run() (catch.hpp:10106)
==11252==    by 0x465129: Catch::Session::run(int, char**) (catch.hpp:10074)
==11252==    by 0x4921A1: main (catch.hpp:13613)
==11252== 
==11252== Conditional jump or move depends on uninitialised value(s)
==11252==    at 0x436516: List<int>::insertFront(int const&) (List.hpp:58)
==11252==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==11252==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==11252==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==11252==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==11252== 
==11252== Conditional jump or move depends on uninitialised value(s)
==11252==    at 0x462AF0: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==11252==    by 0x4409CB: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==11252==    by 0x430414: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==11252==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==11252==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==11252==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==11252==    by 0x45EED6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==11252== 
==11252== HEAP SUMMARY:
==11252==     in use at exit: 240 bytes in 10 blocks
==11252==   total heap usage: 2,347 allocs, 2,337 frees, 268,272 bytes allocated
==11252== 
==11252== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==11252==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==11252==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==11252==    by 0x436493: List<int>::insertFront(int const&) (List.hpp:51)
==11252==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==11252==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==11252==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==11252==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==11252== 
==11252== LEAK SUMMARY:
==11252==    definitely lost: 240 bytes in 10 blocks
==11252==    indirectly lost: 0 bytes in 0 blocks
==11252==      possibly lost: 0 bytes in 0 blocks
==11252==    still reachable: 0 bytes in 0 blocks
==11252==         suppressed: 0 bytes in 0 blocks
==11252== 
==11252== For counts of detected and suppressed errors, rerun with: -v
==11252== Use --track-origins=yes to see where uninitialised values come from
==11252== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==11270== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==11270== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==11270== Command: ./test -r xml "List::_destroy\ empty\ list"
==11270== 
==11270== 
==11270== HEAP SUMMARY:
==11270==     in use at exit: 0 bytes in 0 blocks
==11270==   total heap usage: 2,355 allocs, 2,355 frees, 269,104 bytes allocated
==11270== 
==11270== All heap blocks were freed -- no leaks are possible
==11270== 
==11270== For counts of detected and suppressed errors, rerun with: -v
==11270== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **aidana2** using **401fca5eb1b190fd412869012e34b2cd6e44f511** (from **February 24th 2020, 11:59:59 pm**)
